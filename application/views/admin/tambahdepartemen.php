                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                    <form action="<?= base_url('admin/karyawan/tambahdepartemenProses');?>" method="POST">
                                    <div class="mb-3 col-md-12">
                                        <label for="departemen" class="form-label">Nama Department *</label>
                                        <input class="form-control" id="departemen" type="text" name="departemen" required>
